...
module Komoju
  ...
  class Payments
    ...
    #
    # @param payments_id: A unique indentifier for the payment
    def refund(payments_id)
      @client.payments.refund(payments_id)
    end
